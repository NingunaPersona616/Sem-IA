...
display(' ')
display(['Minimo global: ']);
display(['Alto: ', num2str(x(1, I_best))]);
display(['Ancho: ', num2str(x(2, I_best))]);
display(['Rotacion: ', num2str(x(3, I_best))]);
display(['Escala: ', num2str(x(4, I_best))]);
